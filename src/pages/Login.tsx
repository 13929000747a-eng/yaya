...
export const Login: React.FC = () => {
    ...
    const { login, loginWithGoogle, isFirstTime } = useAuth();
    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Navigation will be handled by useEffect in App based on isFirstTime
        ...
        <div className="auth-container">
            <div className="auth-card">
                <div className="auth-header">
                    <h1 className="auth-title">YaYa IELTS Login</h1>
                    <p className="auth-subtitle">AI 雅思口语练习</p>
                </div>
